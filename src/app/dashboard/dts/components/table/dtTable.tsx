...
const initialDts: IDt[] = [
  { dt_id: "D001", dni: "12345678", firstname: "Juan", lastname: "Pérez", team:  {team_id: "", name: "", category: {categoryId: 0, categoryName: ""}} },
  // ... más DTs
];
...
export default function DtTable() {
  ...
  const renderCell = (dt: IDt, columnKey: keyof IDt | "actions") => {
    ...
    if (columnKey === "team") {
      return dt.team.name || 'Sin equipo';  // Muestra el nombre del equipo
    }
